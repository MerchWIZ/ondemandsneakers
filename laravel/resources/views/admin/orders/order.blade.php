    ...
    <div class="col-lg-12 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a class="btn btn-info" href="{{url('/uploads/quest/orders')}}/{{$orders->id}}.hl7">View Order File</a>
                </div>
            </div>
            <div class="box-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{url('uploads/orders/results')}}/{{$result->file}}" class="btn-sm btn-info"> View Report</a> | <a href="{{url('admin/orders/results/edit/')}}/{{$result->id}}" class="btn-sm btn-warning"> Edit</a> | <a href="{{url('admin/orders/results/delete/')}}/{{$result->id}}" class="btn-sm btn-danger"> delete</a> </td>
                        </tr>
                        @endforeach
